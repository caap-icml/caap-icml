...
class MainController:
    def __init__(self, root):
        ...
        # ScreenCommentator 
        external_saved_checkpoint_root_path = ".."
    ...
    def fill_frame__LLM_Recorder(self, frame):
        ...
        button = tk.Button(frame, width=40, height=2, text="LLM Recorder",
    ...
    def fill_frame__RUN(self, frame):
        ...
        txt_label.pack(side='left')
        txt_label = tk.Label(subframe, text="xx / xx (00 %)  PASS xx (00 %)", name='txt1')
        txt_label.pack(side='left')
